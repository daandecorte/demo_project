...
namespace Unittests.Cities
{
    [TestClass]
    public class UpdateCityCommandTests
    {
        private Mock<ICountryRepository> countryRepoMock;
        ...
        public async Task TestNameEmpty()
        {
            ...
            var command = new UpdateCityCommand { City = city };

            var validator = new UpdateCityCommandValidator(countryRepoMock.Object);
        ...
        public async Task TestCountryDoesNotExist()
        {
            ...
            countryRepoMock.Setup(r => r.GetByIdAsync(99)).ReturnsAsync((Country)null);
        ...
        public async Task TestSuccessfulUpdateValidation()
        {
            ...
            countryRepoMock.Setup(r => r.GetByIdAsync(1)).ReturnsAsync(new Country());
